...
public class AppTest {
    ...
    public void SalvarImagemCorretamente() {
        ...
        Mockito.verify(service, Mockito.times(1)).save(Mockito.eq(product)); // Verifica o produto passado
    }
    ...
    public void DeletarImagemCorretamente() {
        ...
        Mockito.verify(service, Mockito.times(1)).remove(Mockito.eq(productId)); // Verifica o ID passado
    }
    ...
    public void AtualizarImagemCorretamente() {
        ...
        Mockito.verify(service, Mockito.times(1)).update(Mockito.eq(product)); // Verifica o produto passado
    }
}
